...
class ImagesApp:
    def __init__(self):
        ...
        self.window = Gtk.Window(title="D-RATS3 About")
        ...
        labeltext = (
                'Rats have worked out that they can use humans to get around \n'
                'the world, and they have done, hopping onto ships and other \n'
                ' human methods of transport to make their way to pastures new.'
                '\nToday, they use the airwaves and internet to come together'
        ...
        self.base_path = os.path.join(self.base_path, '../images')
        filename = os.path.join(self.base_path, 'd-rats-logo-md.png')
        ...
        labeltext = (
            '<span font_family="courier"><b><big><big><big>D-RATS</big></big></big></b>'
                '\nVersion: 3.0.1'
                '\n'
            '</span>'
            '\n<span font_family="courier">'
                '<b><big>Current Authors</big></b>'
                '\nJonathan Kelley, N5IPT'
                '\n'
            '</span>'
            '\n<span font_family="courier">'
                '<b><big>Original Code/Concept</big></b>'
                '\nDan Smith (KK7DS)'
            '</span>'
            )
        label = Gtk.Label()
        ...
        label = Gtk.Label()
        label.set_markup('<u>Loading Spinner</u>')
        vbox.pack_start(label, False, False, 0)
        ...
        img_path = path.join(self.base_path, 'throbber-large.gif')
